...
void GameState::Initialize()
{
    ...
    mFogEffect.Initialize();
    mFogEffect.SetCamera(mCamera);
    mFogEffect.SetFogValues(1.0f, 10.0f);
...
void GameState::Render()
{
    ...
    mFogEffect.Begin();
    DrawRenderGroup(mFogEffect, mCharacter);
    mFogEffect.Render(mGround);
    mFogEffect.End();
