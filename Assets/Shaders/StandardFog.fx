...
float4 PS(VS_OUTPUT input) : SV_Target
{
    ...
    if (useNormalMap)
    {
        ...
        n = normalize(mul(unpackedNormal, tbnw));
    }
    ...
    if (useFog)
    {
        ...
        //float4 localColor = float4(0.5f, 0.5f, 0.5f, 1.0f);
        //float4 localColor = fogColor;
        ...
        finalColor = input.fogFactor * finalColor + (1.0 - input.fogFactor) * fogColor;
    }
