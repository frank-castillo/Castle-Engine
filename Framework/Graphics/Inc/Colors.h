...
#ifndef INCLUDED_CASTLEENGINE_COLORS_H
#define INCLUDED_CASTLEENGINE_COLORS_H

#include <Math/Inc/CEMath.h>

namespace CASTLEEngine {

    using Color = CASTLEEngine::CEMath::Vector4;
...
#endif // #ifndef INCLUDED_CASTLEENGINE_COLORS_H