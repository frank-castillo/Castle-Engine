...
{
    struct Matrix4;
    struct CASTLEEngine::CEMath::Vector3;
    ...
    struct Quaternion
    {
        ...
        static Quaternion LookRotation(const Vector3& lookAt, const Vector3& upDirection) noexcept; // Get the face fronting direction
